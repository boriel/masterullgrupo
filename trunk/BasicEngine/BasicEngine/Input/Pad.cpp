...
void cPad::Init( unsigned luiPadIndex )
{
   ...
   unsigned int luiNumPads = cInputManager::Get().mpOISInputManager->getNumberOfDevices(OIS::OISJoyStick); //Puetso el unsigned ya que no coincidía, saltaba un warning
