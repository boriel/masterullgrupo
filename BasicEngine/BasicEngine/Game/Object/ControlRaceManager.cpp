...
bool cControlRaceManager::Init() 
{	//Crear ControlRace para cada Vehicle
...
void cControlRaceManager::Deinit()
{
	delete mpControlRace;
}

void cControlRaceManager::Update(float lfTimestep)
{
...
void cControlRaceManager::Render()
{
...
bool cControlRaceManager::LoadObjectsXml(std::string lsResource)
